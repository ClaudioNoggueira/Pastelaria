 ...
 * @author claud
 */
public class FrmInserirPastel extends javax.swing.JFrame {
    ...
    private void btnInserirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInserirActionPerformed
        ...
        pastelBEAN = contPast.inserir(pastelBEAN);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmInserirPastel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmInserirPastel().setVisible(true);
            }
        });
    }
