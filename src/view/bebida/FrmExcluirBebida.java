 ...
 * @author claud
 */
public class FrmExcluirBebida extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Excluir bebida");
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        bebidaBEAN.setIdBebida((Integer) tblDados.getValueAt(linhaTabela, 0));
        bebidaBEAN.setNome_bebida((String) tblDados.getValueAt(linhaTabela, 1));
        bebidaBEAN.setPreco((Float) tblDados.getValueAt(linhaTabela, 2));
        bebidaBEAN.setImg_bebida((String) tblDados.getValueAt(linhaTabela, 3));
        bebidaBEAN.setDescricao((String) tblDados.getValueAt(linhaTabela, 4));

        Object[] opcoes = {"Sim", "Não"};
        int i = JOptionPane.showOptionDialog(
                null, "Deseja excluir esse bebida: '" + bebidaBEAN.getNome_bebida() + "' ?",
                "Exclusão", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE,
                null, opcoes, opcoes[0]);

        if (i == JOptionPane.YES_OPTION) {
            bebidaBEAN = contBeb.excluir(bebidaBEAN);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmExcluirBebida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmExcluirBebida().setVisible(true);
            }
        });
    }
