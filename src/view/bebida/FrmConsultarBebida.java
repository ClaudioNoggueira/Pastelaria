 ...
 * @author claud
 */
public class FrmConsultarBebida extends javax.swing.JFrame {
    ...
    public void visuLista(List<BebidaBEAN> listaDeDados) {
        DefaultTableModel tbm = (DefaultTableModel) tblDados.getModel();
        for (int i = tbm.getRowCount() - 1; i >= 0; i--) {
            tbm.removeRow(i);
        }
    ...
    public void visuResult(BebidaBEAN bebidaBEAN) {
        DefaultTableModel tbm = (DefaultTableModel) tblDados.getModel();
        for (int i = tbm.getRowCount() - 1; i >= 0; i--) {
            tbm.removeRow(i);
        }
        tbm.addRow(new String[1]);
        tblDados.setValueAt(bebidaBEAN.getIdBebida(), 0, 0);
        tblDados.setValueAt(bebidaBEAN.getNome_bebida(), 0, 1);
        tblDados.setValueAt(bebidaBEAN.getPreco(), 0, 2);
        tblDados.setValueAt(bebidaBEAN.getImg_bebida(), 0, 3);
        tblDados.setValueAt(bebidaBEAN.getDescricao(), 0, 4);
    }

    public FrmConsultarBebida() {
        initComponents();
        visuGeral();
        visuDataHora();
    }
    ...
    private void btnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsultarActionPerformed
        ...
        if (chkNome.isSelected() == true) {
            ...
            List<BebidaBEAN> listaDeDados = new ArrayList<>();
            listaDeDados = contPast.consultarNome(bebidaBEAN);
            lblStatus.setText(bebidaBEAN.getStatus());
            visuLista(listaDeDados);
        } else if (chkID.isSelected() == true) {
            txtNome.setText("");
            bebidaBEAN.setIdBebida(Integer.parseInt(txtID.getText()));
            bebidaBEAN = contPast.consultarID(bebidaBEAN);
            lblStatus.setText(bebidaBEAN.getStatus());
            visuResult(bebidaBEAN);
        } else {
    ...
    private void btnVoltarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVoltarActionPerformed
        FrmBebida menuProdutos = new FrmBebida();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmConsultarBebida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmConsultarBebida().setVisible(true);
            }
        });
    }
